...
public class CovidCaseTracker extends JFrame implements ActionListener
{
	...
	this.setResizable(false);
		...
		setBounds(460, 100, 504, 546);
		contentPane = new JPanel();
		contentPane.setForeground(new Color(100, 100, 100));
		contentPane.setBackground(new Color(255, 240, 230));
		contentPane.setBorder(new LineBorder(new Color(0, 128, 128), 5));
		setContentPane(contentPane);
		contentPane.setLayout(null);
		
		JLabel covidtrackerlabel = new JLabel("CORONA VIRUS CASES");
